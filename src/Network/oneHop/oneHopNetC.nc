...
generic configuration oneHopNetC() {
...
implementation {
  ...
  components new oneHopNetP();
  Mgmt = oneHopNetP;
  Module = oneHopNetP;
  NetworkCall = oneHopNetP;
  NetworkSignal = oneHopNetP;
  MacCall = oneHopNetP;
  MacSignal = oneHopNetP;

  components AddressingC;
  oneHopNetP.Addressing -> AddressingC.Addressing[F_NETWORK_ADDRESSING];
}
