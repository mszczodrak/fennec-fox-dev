...
implementation {
  ...
  Occurence = phidget_1108_0_driverP.Occurence;

  components new Msp430Adc12ClientC();
  phidget_1108_0_driverP.Msp430Adc12SingleChannel -> Msp430Adc12ClientC;
  phidget_1108_0_driverP.Resource -> Msp430Adc12ClientC;

  components new BatteryC();
  phidget_1108_0_driverP.Battery -> BatteryC.Read;
