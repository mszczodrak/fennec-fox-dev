...
implementation {
  ...
  Occurence = phidget_1111_0_driverP.Occurence;

  components new Msp430Adc12ClientC();
  phidget_1111_0_driverP.Msp430Adc12SingleChannel -> Msp430Adc12ClientC;
  phidget_1111_0_driverP.Resource -> Msp430Adc12ClientC;
