...
SWIGINTERN PyObject *_wrap_SerialForwarder_close(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  SerialForwarder *arg1 = (SerialForwarder *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:SerialForwarder_close",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_SerialForwarder, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "SerialForwarder_close" "', argument " "1"" of type '" "SerialForwarder *""'"); 
  }
  arg1 = reinterpret_cast< SerialForwarder * >(argp1);
  (arg1)->close();
  resultobj = SWIG_Py_Void();
...
SWIGINTERN PyObject *_wrap_Mote_writeInput(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOO:Mote_writeInput",&obj0,&obj1,&obj2,&obj3)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Mote, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "Mote_writeInput" "', argument " "4"" of type '" "long long""'");
  } 
  arg4 = static_cast< long long >(val4);
  (arg1)->writeInput(arg2,arg3,arg4);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_Mote_readOutput(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOO:Mote_readOutput",&obj0,&obj1,&obj2)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Mote, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  ecode3 = SWIG_AsVal_long_SS_long(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "Mote_readOutput" "', argument " "3"" of type '" "long long""'");
  } 
  arg3 = static_cast< long long >(val3);
  result = (arg1)->readOutput(arg2,arg3);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"SerialForwarder_close", _wrap_SerialForwarder_close, METH_VARARGS, NULL},
