...
implementation {
  ...
  task void setup_app() {
    ...
    call Sensor_0_Setup.set_input_channel(call phidget1142And1111AppParams.get_s1_inputChannel());
    ...
    call Sensor_1_Setup.set_input_channel(call phidget1142And1111AppParams.get_s2_inputChannel());
